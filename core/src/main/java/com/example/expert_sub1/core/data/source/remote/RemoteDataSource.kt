package com.example.expert_sub1.core.data.source.remote

import android.util.Log
import com.example.expert_sub1.core.data.source.remote.network.ApiResponse
import com.example.expert_sub1.core.data.source.remote.network.ApiService
    ...
    suspend fun getTrendingMovies(): Flow<ApiResponse<List<MovieResponse>>> {
        return flow {
            try {
                ...
                val dataArray = response.movies.filter {
